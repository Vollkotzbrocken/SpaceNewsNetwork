...
import de.keinesupportanfragen.spacenewsnetwork2.databinding.FragmentBlogEntryBinding
...
class MyBlogEntryRecyclerViewAdapter(
    private var values: List<Article>, private var fragment: Fragment
) : RecyclerView.Adapter<MyBlogEntryRecyclerViewAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        return ViewHolder(
            FragmentBlogEntryBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.shareArticleButton.setOnClickListener {
    ...
    inner class ViewHolder(binding: FragmentBlogEntryBinding) : RecyclerView.ViewHolder(binding.root) {
        val titleText: TextView = binding.blogArticleTitle
        val summaryText: TextView = binding.blogArticlePreview
        val imageView: ImageView = binding.blogImageView
        val moreInfoText: TextView = binding.blogArticleMoreInfo

        val shareArticleButton: Button = binding.shareBlogButton
